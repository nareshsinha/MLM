...
<table width="990" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
	...
	$lid2 =mysqli_query($conn,"SELECT SUM(left_id) FROM ".$mem_name."") or die(mysqli_error());
	$lresult = mysqli_result($lid2, 0);
	$lid=$lresult;
	
	$rid2  =mysqli_query($conn,"SELECT SUM(right_id) FROM ".$mem_name."") or die(mysqli_error());

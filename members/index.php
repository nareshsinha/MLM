...
$message ="pwd cannot be blank";
 ...
 {
	 //print_r($_SESSION);
 $sql = "select username,pwd,mem_name,statuse from members where username = '".$_SESSION['username'] ."' and  pwd = '".$_SESSION['pwd']."'";
$result = mysqli_query($conn, $sql) or die ('Error1: '.mysqli_error ($conn));
//print_r($result);
$results = mysqli_fetch_array($result) or die ('Error: '.mysqli_error ());
$test="deactive";
$mem_name2=$results['mem_name'];
if($test==$results['statuse'])
{
$message1 = "Sorry, your account is not active.";
}
else
{
...
header('location:main.php?membersname='.$mem_name.'');
}
else{
              ...
              <tr>
                <td align="left" valign="top">
                      ...
                      <tr align="left" valign="top"> 
                        <td width="50%" height="20" valign="bottom"><strong>Members
                      ...
                      <tr align="left" valign="top"> 
                        <td width="50%" valign="middle"><div align="right">pwd 
                            :&nbsp;&nbsp;&nbsp;</div></td>
                        <td width="50%"><input type="pwd" name="pwd" class="TaskEdit_tf" style="width:100%"></td>
                      </tr>
                        ...
                        <td colspan="2"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              ...
                              <td width="19" align="center" ><div align="right"> 
                                  <input type="submit" name="Submit" value="Member Login" class="TaskEdit_tf">
                                </div></td>
                            </tr>
                          </table></td>
                      </tr>

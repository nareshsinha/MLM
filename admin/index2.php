                ...
                <td align="left" valign="top">
                      ...
                      <tr align="left" valign="top"> 
                        <td width="50%" valign="middle"><div align="right">User 
                            Name :&nbsp;&nbsp;&nbsp;</div></td>
                        <td width="50%"><input type="text" name="username" class="TaskEdit_tf" style="width:100%" value="<?php echo $_SESSION['username']; ?>"></td>
                      </tr>
                      <tr align="left" valign="top"> 
                      ...
                      <tr align="left" valign="top"> 
                        <td width="50%" valign="middle"><div align="right">Password 
                            :&nbsp;&nbsp;&nbsp;</div></td>
                        <td width="50%"><input type="password" name="password" class="TaskEdit_tf" style="width:100%" value="<?php echo $_SESSION['password']; ?>"></td>
                      </tr>
                      <tr align="left" valign="middle"> 
                        <td height="30" colspan="2"><font color="#FF0000"><?php echo $message; ?></font></td>
                      </tr>
                      <tr align="left" valign="top"> 

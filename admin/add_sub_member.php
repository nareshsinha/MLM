...
if(empty($message1))
		{
				...
				values('".$date."','".$check_no."','".$check_dt."','".$amount."','".$enroller_id."','".$enrolled_id."')";
							...
							$result1=mysqli_query($conn,$pql1);
              ...
              <table width="95%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#D4D4C8">
                ...
                <tr> 
                  ...
                  <td bgcolor="#FFFFFF" class="blue_txt"><input name="mem_name" type="text" id="mem_name" size="40"> 
					...
					<?php echo $message1[0]; ?></strong></font></td>
                </tr>
...
&nbsp;<font color="#000000"><strong><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> <?php echo $message1[1]; ?></strong></font></td>
                                </tr>
...
&nbsp;<font color="#000000"><strong><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> <?php echo $message1[2]; ?></strong></font> </td>
                                </tr>
...
&nbsp;<font color="#000000"><strong><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong><?php echo $message1[3]; ?></strong></font></td>
                                </tr>
...
&nbsp;<font color="#000000"><strong><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><?php echo $message1[4]; ?></strong></font> </td>
                                </tr>
...
&nbsp;<font color="#000000"><strong><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong><?php echo $message1[6]; ?></strong></font></td>
                                </tr>
<tr>
...
&nbsp;<font color="#000000"><strong><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> <?php echo $message1[9]; ?></strong></font> </td>
                                </tr>
...
&nbsp;<font color="#000000"><strong><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><?php echo $message1[8]; ?></strong></font> </td>
                                </tr>
...
&nbsp;<font color="#000000"><strong><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong><?php echo $message1[7]; ?></strong></font></td>
                                </tr>
...
-->
                    ...
                    &nbsp;<font color="#000000"><strong><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><?php echo $message1[11]; ?></strong></font></td>
			    </tr>
				 <tr>
...
&nbsp; <font color="#000000"><strong><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $message1[12]; ?></strong></font></td>
			    </tr>
				 <tr>
                                   <td height="15" bgcolor="#FFFFFF" class="blue_txt"><div align="right"><font color="#990000"><strong><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Enroleer ID  
                                     :</font></strong></font></div></td>
								   <td bgcolor="#FFFFFF" class="blue_txt"><input name="enroller_id"  disabled="disabled" type="text" id="enroller_id" size="40" value="<?php echo $enroller_id;?>">
                                   </td>
			    </tr>
...
$real_enroller_id = trim($enroller_id2, "e707e");		
				  ?>
								  ...
								  <input name="enroller_id2" disabled="disabled" type="text" id="Enrolled" size="40" value="<?php echo $enrolled_id2;?>"> 
								  <input name="real_enroller_id" type="hidden" id="real_enroller_id" size="40" value="<?php echo $real_enroller_id;?>"> 
								                                   </td>
                                </tr>

...
<br>
	  ...
	  <div align="center">
	    ...
	    <table id="Table_01" width="646" height="415" border="0" cellpadding="0" cellspacing="0">
	      <tr>
	        <td colspan="5">&nbsp;<?php  echo $enrolled_id_2; ?></td>
		    <td width="123" height="84" colspan="3" align="center" valign="middle" background="images/tree_09.gif">	
		      ...
		      <div align="center" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-weight:bold; font-size:11px;margin:10px 10px 10px 10px;"><a href=# color=white>
				...
				$query  = "SELECT * from members where enrolled_id='".$enrolled_id_2."'";
					$querys=mysqli_query($conn,$sql)or die(mysqli_error());
		        ...
		        <font color=white><?php echo $mem_name_1?></font></a> <BR>
		        ID: <?php echo $enrolled_id_1?><br>
...
<?
			...
			font-weight:bold; font-size:11px;margin:10px 10px 10px 10px;"> <font color=white><a href=# color=white>
		      <?
 					...
 					$queryq=mysqli_query($conn,$sqlq)or die(mysqli_error());
...
<?
 					...
 					$queryde=mysqli_query($conn,$sqlde)or die(mysqli_error());
			...
			font-weight:bold; font-size:11px;margin:10px 10px 10px 10px;"> <font color=white><a href=# color=white>
		      <?
 					...
 					$queryr=mysqli_query($conn,$sqlr)or die(mysqli_error());
...
<?
 					...
 					$queryd=mysqli_query($conn,$sqld)or die(mysqli_error());
			...
			font-weight:bold; font-size:11px;margin:10px 10px 10px 10px;"> <font color=white><a href=# color=white>
		      <?
 					...
 					$queryqat=mysqli_query($conn,$sqlqat)or die(mysqli_error());
